...
namespace CompilableTypeConverter
{
	...
	/// successfully-retrieved converters are cached by the caller (using the TryToGetConverter method) rather than calling the Convert methodfrequently
	...
	public static class Converter
	{
			...
			ConverterOverrideBehaviourOptions converterOverrideBehaviour = ConverterOverrideBehaviourOptions.UseAnyExistingConverter)
		{
			...
			lock (_lock)
			{
				return _converter.GetConverter<TSource, TDest>(propertiesToIgnoreIfSettingPropertiesOnTDest, converterOverrideBehaviour);
			}
		}
		public static ICompilableTypeConverter<TSource, TDest> GetConverter<TSource, TDest>(
			ConverterOverrideBehaviourOptions converterOverrideBehaviour = ConverterOverrideBehaviourOptions.UseAnyExistingConverter)
